...
data20 <- data19 %>%
  mutate(time_to_notification = as.numeric(difftime(notification_date, diagnosis_date, units = "days"))) %>%
...
data_dup28<- data_dup27 %>%
  select(nmccategories, condition, case_id, case_type, 
         ...
         folder_no, patient_name, patient_surname, patient_dob, age, agecategory, gender, pregnancystatus, id_type, patient_id_no, 
